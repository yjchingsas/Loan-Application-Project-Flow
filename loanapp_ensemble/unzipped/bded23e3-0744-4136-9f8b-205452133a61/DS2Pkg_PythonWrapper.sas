...
in_out varchar(100) "I_Default");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_870db58a-de11-43ac-9744-6139ec6c4ce5', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import _4eciaroqodklgq7s8o0p6y4r5_13c576e1_7a69_4727_9305_b2c830fa09be');
         ...
         resultCode = pm.appendSrcLine('    return _4eciaroqodklgq7s8o0p6y4r5_13c576e1_7a69_4727_9305_b2c830fa09be.score_method(Delinquencies, DerogatoryMarks, Inquiries, JobType, CredLineAge, CredLines, DebtIncRatio, LoanRequest, HomeValue, Income, LoanToValue, YearsOnJob)');

         revision = pm.publish(pm.getSource(), 'model_exec_870db58a-de11-43ac-9744-6139ec6c4ce5');
